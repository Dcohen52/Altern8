...
global_symbol_table.set("read", BuiltInFunction.input)
global_symbol_table.set("read_int", BuiltInFunction.input_int)
...
global_symbol_table.set("get_functions", BuiltInFunction.get_functions)
